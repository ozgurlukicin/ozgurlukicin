...
urlpatterns = patterns('oi.shipit.views',
    ...
    (r'^gonderilecek/(?P<version>[a-z0-9-_]+)/$', 'cdclient_list_to_send'),
    (r'^gonderildi/$', 'cdclient_list_sent'),
    (r'^gonderildi/(?P<version>[a-z0-9-_]+)/$', 'cdclient_list_sent'),
    (r'^gonderilmedi/$', 'cdclient_list_not_sent'),
    (r'^gonderilmedi/(?P<version>[a-z0-9-_]+)/$', 'cdclient_list_not_sent'),
