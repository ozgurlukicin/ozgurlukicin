...
class ShopProfile(models.Model):
    ...
    tcno = models.IntegerField("TC kimlik no", help_text="TC Kimlik numaranız.")
    ...
    billing_address = models.CharField('Fatura Adresi', max_length=200, help_text="Fatura için adres")
