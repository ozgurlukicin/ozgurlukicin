...
class RegisterForm(forms.Form):
    ...
    contributes_summary = forms.CharField(label=_("Comment"), widget=forms.Textarea(attrs={'rows': 7, 'cols': 45}), required=False, help_text=_("Make comments about your contribution (not required)")
...
class ProfileEditForm(forms.Form):
    ...
    signature = XssField(label=_("Sign"), widget=forms.Textarea(attrs={'rows': 7, 'cols': 45}), required=False, help_text=_("This will be shown under your posts in forum pages (512 characters max.)"), max_length=512)
