...
$(document).ready(function() {
    ...
    $(".image").before("<div class=\"form-row image_filter\"><div><label for=\"image_filter\">Görselleri Filtrele</label><input type=\"text\" maxlength=\"32\" name=\"image_filter\" class=\"vTextField\" id=\"filter\"/><p class=\"help\">Burayı kullanarak görsellerde arama yapabilirsiniz.</p></div></div>");
